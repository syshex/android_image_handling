...
public class CropImage extends MonitoredActivity {
        ...
        try {
            ...
            if (o.outHeight > IMAGE_MAX_SIZE || o.outWidth > IMAGE_MAX_SIZE) {
                scale = (int) Math.pow(2, (int) Math.round(Math
                        .log(IMAGE_MAX_SIZE / (double) Math.max(o.outHeight, o.outWidth)) /
                        Math.log(0.5)));
            }
    ...
    Runnable mRunFaceDetection = new Runnable() {
        ...
        private Bitmap prepareBitmap() {
            ...
            //Fix implemented for some devices
            if (mBitmap.isRecycled()) {
                mBitmap = BitmapFactory.decodeFile(mImagePath);
            }
            //--------------------------------
            return Bitmap
                    .createBitmap(mBitmap, 0, 0, mBitmap.getWidth(), mBitmap.getHeight(), matrix,
                            true);
        }
